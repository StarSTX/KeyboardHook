...
using System.Text;
using static KeyboardHook.KeyboardKey;
...
namespace KeyboardHook
{
    ...
    public sealed class GlobalKeyboardHook : IDisposable
    {
        ...
        private IntPtr HookCallback(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            {
                _pressedKeys.Add(KeyFromVirtualKey(Marshal.ReadInt32(lParam))); // vkCode (in KBDLLHOOKSTRUCT) is DWORD (actually it can be 0-254)
